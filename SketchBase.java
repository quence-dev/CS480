...
{	
	...
	public static Mesh3D depthBuff;
	public static float z0, z1, z2;
	 ...
	 * @param v0 
	 */
	public static void drawTriangle(BufferedImage buff, Point2D p1, Point2D p2, Point2D p3, boolean do_smooth, Mesh3D _db, Point3D v0, Point3D v1, Point3D v2)
	{
	...
	public static boolean getDepth(Point2D p) {
		if (depthBuff.v[p.x][p.y].z < Integer.MAX_VALUE) {
			return true;
		} else {
			return false;
		}

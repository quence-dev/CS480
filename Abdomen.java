/**
 * Abdomen.java - a model for the abdomen of an ant
 */
...
/**
 * A model for the abdomen as a sphere scaled in two directions.
 * 
 * @author Jeffrey Finkelstein <jeffrey.finkelstein@gmail.com>
 * @since Spring 2011
 */
public class Abdomen extends Circular implements Displayable {
   ...
   */
  public Abdomen(final double radius, final GLUT glut) {
    super(radius, glut);
  }

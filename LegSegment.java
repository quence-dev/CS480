/**
 * LegSegment.java - a model for the leg segments of an ant
 */
 ...
 * @since Spring 2011
 */
public class LegSegment extends Circular implements Displayable {
  /**
   ...
   */
  public LegSegment(final double radius, final double height,
      final GLUT glut) {
    super(radius, glut);
    this.height = height;
  }
